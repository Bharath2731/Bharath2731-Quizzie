  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.optionsAndTimer}>
        <div className={styles.options}>
          ...
          {questions[currentIndex].options.length < 4 && (
            ...
            {/* no timer for poll type question */}
      ...
      <div className={styles.canelAndCreateQuiz}>
        ...
        <button className={styles.createQuizBtn} onClick={handleCreateQuiz}>Create Quiz</button>
      </div>
    </div>
  );
}

export default PollTypeTemplate;
